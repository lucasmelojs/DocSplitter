...
class Settings(BaseSettings):
    ...
    DEFAULT_LANG: str = "Portuguese" # Default language we assume files to be in, should be one of the keys in TESSERACT_LANGUAGES
    ...
    def TEXIFY_DTYPE(self) -> torch.dtype:
        return torch.float32 if self.TORCH_DEVICE_MODEL == "mps" else torch.float16
